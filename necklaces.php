...
<div class="main">
    <div class="welcome">
        <div>
            <img src="img/Z4bbnZOFXLrcNLAKCOeC.jpg" height="150px" width="170px" >
        </div>
        <div>
            <h1>Necklaces</h1>
            <p>Sollicitudin nibh sit amet commodo nulla. Velit dignissim sodales ut eu 
                sem integer vitae justo. Urna molestie at elementum eu facilisis. A pellentesque
                sit amet porttitor eget. Aliquet nec ullamcorper sit amet risus nullam eget felis.
                Sed velit dignissim sodales ut eu. Et egestas quis ipsum suspendisse ultrices 
                gravida dictum. Interdum varius sit amet mattis vulputate enim nulla aliquet porttitor.</p>
        </div>
    </div>
